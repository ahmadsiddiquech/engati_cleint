...
<head>
  <meta charset="utf-8">
  <title>Engati - Banking & Finance</title>
		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Banking & Finance</li>
				</ol>
			</nav>
		</div>
	...
	<div class="container">
		...
		<div class="team">
				<div class="tab-pane pl-sm-5 fade animated fadeInLeft about-message" role="tabpanel">
						...
						<p>BFSI sector has recently seen big improvements in services, security, and availability standards. Machine Learning and Artificial Intelligence have been at the forefront of this change.</p>
						<p>Smart banking chatbots now are digital assistants that engage well with the customers. They can fetch information and execute transactions in real-time. This allows regular banking transactions to be available on command of your customers. Key capabilities include:</p>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Lead generation </li>
							<li><i class="fa fa-check"></i> Product Selection and Marketing</li>
							<li><i class="fa fa-check"></i> Promotional messages in a sales push </li>
							<li><i class="fa fa-check"></i> Claim & Premium Processing</li>
						</ul>
					</div>
		</div><!-- Team end -->
