...
<head>
  <meta charset="utf-8">
  <title>Engati - Real Estate</title>
		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Real Estate</li>
				</ol>
			</nav>
		</div>
	...
	<div class="container">
		...
		<div class="team">
				<div class="tab-pane pl-sm-5 fade animated fadeInLeft about-message" role="tabpanel">
						...
						<p>Buying/Selling a property is a tedious task. The client would want to know anything and everything about the property. These queries don’t come all at once but over a period of time. Smart Chatbots help sell & provide support in such situations. </p>
						<p>Artificial Intelligence driven chatbots help handle queries at all times of the day. For businesses, this provides a big cost saving. Customers also benefit by getting responses with speed and 24x7. By understanding the customer ask, chatbots can further accelerate property selection. Overall key capabilities that a real estate chatbot can provide include: </p>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Lead Generation & Nurturing </li>
							<li><i class="fa fa-check"></i> Promotional Campaigns </li>
							<li><i class="fa fa-check"></i> Property Tours & Images </li>
							<li><i class="fa fa-check"></i> Automated Support on Property Queries</li>
							<li><i class="fa fa-check"></i> Regulation & Process Guidance </li>
			...
			<div class="col-md-3 col-sm-5">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<a class="animated fadeIn nav-link mb-1 active d-flex align-items-center" data-toggle="pill" href="#tab_1"
						...
						<span class="h4 mb-0 font-weight-bold">Owner/Seller</span>
					</a>
					<a class="animated fadeIn nav-link mb-1 d-flex align-items-center" data-toggle="pill" href="#tab_2" role="tab"
						...
						<span class="h4 mb-0 font-weight-bold">Rentee/Buyer</span>
					</a>
			...
			<div class="col-md-9 col-sm-7">
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane pl-sm-5 active fade animated fadeInLeft" id="tab_1" role="tabpanel">
						...
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Share Property Details</li>
							<li><i class="fa fa-check"></i> Recieve best Price Quotes</li>
							<li><i class="fa fa-check"></i> Share Property Documents for Validation</li>
							<li><i class="fa fa-check"></i> Track Demand</li>
							<li><i class="fa fa-check"></i> Automate Lead Generation</li>
						</ul>
					</div>
					<div class="tab-pane pl-sm-5 fade animated fadeInLeft" id="tab_2" role="tabpanel">
						<h3>Benefits for Rentee/Buyer</h3>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Get Property Tour</li>
							<li><i class="fa fa-check"></i> Get Validation Documents</li>
							<li><i class="fa fa-check"></i> Get Quoted Price</li>
							<li><i class="fa fa-check"></i> Get Best Deals</li>
							<li><i class="fa fa-check"></i> Share Documents for Verifications</li>
						</ul>
					</div>
				</div>
			</div>
