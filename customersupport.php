		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Customer Support</li>
				</ol>
			</nav>
		</div>
...
<section id="main-container">
	<div class="container">
		...
		<div class="row about-wrapper-top">
			<div class="col-md-6 ts-padding ">
				...
				<p><a href="#" class="btn btn-primary solid square" style="color: #2D7A8A">Get Started Free<i class="fa fa-long-arrow-right"></i></a></p>
	...
	<div class="container">
		...
		<!-- Team start -->
		<div class="team">
				<div class="tab-pane pl-sm-5 fade animated fadeInLeft about-message" role="tabpanel">
						<!-- <img class="img-fluid float-right" src="images/tab/featured-tab2.png" alt=""> -->
						<h3 class="pt-5">The Big Idea</h3>
						<p>Support is the critical function for a satisfied customer base. The waiting time expected by customers today is very less. Chatbots are helping support be more efficient and available at all times.
</p>
						<p> Chatbots are programmed to learn from past conversations and they continue to evolve. With the chatbots handling bulk of the simpler queries, your team is free to focus on the heavy lifting. The entire support team can be up-skilled to focus on complex queries. Organisations are rolling this model out and seeing customer experience improve. Key capabilities being rolled out include: 
</p>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> 24x7 Service availability </li>
							<li><i class="fa fa-check"></i> Empower your support team</li>
							<li><i class="fa fa-check"></i> Automated ticket creation </li>
							<li><i class="fa fa-check"></i> Seamless transition from digital to human </li>
							<li><i class="fa fa-check"></i> Automated support status tracking </li>
						</ul>
					</div>
		</div><!-- Team end -->
...
<section id="feature" class="feature">
	...
	<div class="row">
			<div class="col-md-12 heading text-center">
				...
				<h2 class="title2">Amazing Features 
					<span class="title-desc">Natural Language Processing</span>
				</h2>
			</div>
		</div>
		<div class="row">
		...
		<div class="row featured-tab">
			<div class="col-md-3 col-sm-5">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					...
					<a class="animated fadeIn nav-link mb-1 d-flex align-items-center" data-toggle="pill" href="#tab_2" role="tab"
						...
						<span class="h4 mb-0 font-weight-bold">Wealth Management</span>
					</a>
					<a class="animated fadeIn nav-link mb-1 d-flex align-items-center" data-toggle="pill" href="#tab_3" role="tab"
						aria-selected="true">
						<i class="fa fa-android mr-4 h3 mb-0"></i>
						<span class="h4 mb-0 font-weight-bold">Payments & Transfers</span>
					</a>
			...
			<div class="col-md-9 col-sm-7">
				<div class="tab-content" id="v-pills-tabContent">
					...
					<div class="tab-pane pl-sm-5 active fade animated fadeInLeft" id="tab_1" role="tabpanel">
						<h3>Benefits of Retail Banking</h3>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Account Registration</li>
							<li><i class="fa fa-check"></i> Report Loss of cards</li>
							<li><i class="fa fa-check"></i> Reset Passwords</li>
							<li><i class="fa fa-check"></i> Apply for new Services</li>
							<li><i class="fa fa-check"></i> Close existing Services</li>
						</ul>
					</div>
					<div class="tab-pane pl-sm-5 fade animated fadeInLeft" id="tab_2" role="tabpanel">
						<h3>Benefits of Wealth Management</h3>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Mutual Fund and Equity Transactions</li>
							<li><i class="fa fa-check"></i> Monitor Portfolio</li>
							<li><i class="fa fa-check"></i> Modify Portfolio</li>
							<li><i class="fa fa-check"></i> Query for Risk Assessment</li>
							<li><i class="fa fa-check"></i> Search for Market Trends</li>
						</ul>
					</div>
					...
					<div class="tab-pane pl-sm-5 fade animated fadeInLeft" id="tab_3" role="tabpanel">
						...
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Transfer money</li>
							<li><i class="fa fa-check"></i> Add/modify payee</li>
							<li><i class="fa fa-check"></i> Add new user account</li>
							<li><i class="fa fa-check"></i> Realtime information based on markets</li>
						</ul>
					</div>
					<div class="tab-pane pl-sm-5 fade animated fadeInLeft" id="tab_4" role="tabpanel">
						<h3>Marketing Benefits</h3>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Product Notifications</li>
							<li><i class="fa fa-check"></i> Communicate Deals & Offers </li>
							<li><i class="fa fa-check"></i> Lead Generation</li>
							<li><i class="fa fa-check"></i> Lead Qualification</li>
						</ul>
					</div>
					<div class="tab-pane pl-sm-5 fade animated fadeInLeft" id="tab_5" role="tabpanel">
						<h3>Insurance Benefits</h3>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Generate Quotes</li>
							<li><i class="fa fa-check"></i> Lead Generation</li>
							<li><i class="fa fa-check"></i> Submit Claims</li>
							<li><i class="fa fa-check"></i> Claim Tracking</li>
							<li><i class="fa fa-check"></i> Buy Insurance</li>
						</ul>
					</div>
				</div>
			</div>
