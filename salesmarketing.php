...
<head>
  <meta charset="utf-8">
  <title>Engati - Sales & Marketing</title>
		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Sales & Marketing</li>
				</ol>
			</nav>
		</div>
	...
	<div class="container">
		...
		<div class="team">
				<div class="tab-pane pl-sm-5 fade animated fadeInLeft about-message" role="tabpanel">
						...
						<p>30% of top-performing companies today use AI-powered marketing chatbots to deliver superior marketing experiences.</p>
						<p>A lot of these experiences are being driven by 24x7 availability. Digital assistants are at the forefront of enabling an always-on presence for businesses. Sales bots answer product queries and help nurture leads to sales completion. They also help with personalized marketing and social media reach. There are a range of automation opportunities in sales & marketing. Key capabilities include:</p>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Lead generation </li>
							<li><i class="fa fa-check"></i> Lead Nurturing and Closure</li>
							<li><i class="fa fa-check"></i> Promotional Campaigns across Social Media</li>
							<li><i class="fa fa-check"></i> Customer Engagement and Analytics</li>
						</ul>
					</div>
		</div><!-- Team end -->
