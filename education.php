		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Education</li>
				</ol>
			</nav>
		</div>
	...
	<div class="container">
		...
		<div class="team">
				<div class="tab-pane pl-sm-5 fade animated fadeInLeft about-message" role="tabpanel">
						...
						<p>How can you assist your new age students? An app requiring many clicks and navigations is not the answer. It is a generation that is fluent in conversation interface and smart educational chatbots can help. </p>
						<p>A Chatbot implementation is further more cost effective than an app. With further cost savings from automated support, chatbots are a clear option. Students & teachers, can use educational chatbots for getting notifications, taking surveys & completing assessments. Prospective students can have a lot of information on their fingertips. Overall capabilities include: </p>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Provide Course Structure, Fees & other details </li>
							<li><i class="fa fa-check"></i> Automate & improve subscription to online courses  </li>
							<li><i class="fa fa-check"></i> Scorecards for Students & teachers </li>
							<li><i class="fa fa-check"></i> Automate administrative tasks for teachers & students </li>
							<li><i class="fa fa-check"></i> Training students with personalisation </li>
			...
			<div class="col-md-4 col-sm-5">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<a class="animated fadeIn nav-link mb-1 active d-flex align-items-center" data-toggle="pill" href="#tab_1"
						...
						<span class="h4 mb-0 font-weight-bold">Organization to Teachers</span>
					</a>
					<a class="animated fadeIn nav-link mb-1 d-flex align-items-center" data-toggle="pill" href="#tab_2" role="tab"
						...
						<span class="h4 mb-0 font-weight-bold">Organization to Students</span>
					</a>
				</div>
			</div>
			<div class="col-md-8 col-sm-7">
				<div class="tab-content" id="v-pills-tabContent">
					<div class="tab-pane pl-sm-5 active fade animated fadeInLeft" id="tab_1" role="tabpanel">
						...
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Share Lecture Schedules</li>
							<li><i class="fa fa-check"></i> Update Course-related Information</li>
							<li><i class="fa fa-check"></i> Request Student Feedback</li>
							<li><i class="fa fa-check"></i> Request Attendance Records</li>
							<li><i class="fa fa-check"></i> Survey Feedback</li>
						</ul>
					</div>
					<div class="tab-pane pl-sm-5 fade animated fadeInLeft" id="tab_2" role="tabpanel">
						<h3>Benefits for Organization to Students</h3>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Assistance in Course Selection</li>
							<li><i class="fa fa-check"></i> Assistance with Applications</li>
							<li><i class="fa fa-check"></i> Pay Online Fees</li>
							<li><i class="fa fa-check"></i> Get Student Feedback Report</li>
							<li><i class="fa fa-check"></i> Share Examination Updates</li>
						</ul>
					</div>
				</div>
			</div>
