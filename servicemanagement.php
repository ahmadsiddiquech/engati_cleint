...
<head>
  <meta charset="utf-8">
  <title>Engati - Service Management</title>
		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Service Management</li>
				</ol>
			</nav>
		</div>
	...
	<div class="container">
		...
		<div class="row about-wrapper-top">
			<div class="col-md-6 ts-padding ">
				<h3>Chatbots for Service Management (ITSM)</h3>
	...
	<div class="container">
		...
		<div class="team">
				<div class="tab-pane pl-sm-5 fade animated fadeInLeft about-message" role="tabpanel">
						...
						<p>Managing IT is an increasingly complex job. To keep the services running, assets secure and users informed is key. New technologies, though are making it easier and cost effective. </p>
						<p>Smart Chatbots are at the forefront of helping IT support functions scale. New age employees including millennials and Generation Z find them convenient. This helps push for self service. Companies have even deployed them for helping the tech team. Uses also include notifications for key changes and especially outage alerts. With faster support all around, ITSM chatbots further help with the increased productivity charter. Key capabilities addressed via chatbots include: </p>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> 24x7 Service & Support availability  </li>
							<li><i class="fa fa-check"></i> Outage Alerts</li>
							<li><i class="fa fa-check"></i> Automation of common tasks  </li>
							<li><i class="fa fa-check"></i> Knowledge Management</li>
						</ul>
					</div>
		</div><!-- Team end -->
