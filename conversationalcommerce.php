...
<head>
  <meta charset="utf-8">
  <title>Engati - Conversational Commerce</title>
		...
		<div class="text-center">
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb justify-content-center">
					...
					<li class="breadcrumb-item text-white" aria-current="page">Conversational Commerce</li>
				</ol>
			</nav>
		</div>
	...
	<div class="container">
		...
		<div class="team">
				<div class="tab-pane pl-sm-5 fade animated fadeInLeft about-message" role="tabpanel">
						...
						<p>By 2023, over 70% of all chatbots accessed will be retail-based. And, annual ecommerce chatbot transactions will reach $112 billion. Digital assistants are helping brands and organizations garner leads and increase conversions. </p>
						<p>Smart chatbots help with shopping and post-sales support. Beyond the customer engagement, they are helping in vendor management as well. Reactive commerce is insufficient to succeed. Ecommerce chatbots also help tap the market when the lead is hot and to convert cold ones with effective communication. Key capabilities include: </p>
						<ul class="check-list">
							<li><i class="fa fa-check"></i> Lead Generation & Nurturing </li>
							<li><i class="fa fa-check"></i> Product Search Guidance </li>
							<li><i class="fa fa-check"></i> Order Tracking Support  </li>
							<li><i class="fa fa-check"></i> Conversational Commerce </li>
						</ul>
					</div>
		</div><!-- Team end -->
			...
			<div class="col-md-3 col-sm-5">
				<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
					<a class="animated fadeIn nav-link mb-1 active d-flex align-items-center" data-toggle="pill" href="#tab_1"
						...
						<span class="h4 mb-0 font-weight-bold">Business to Consumer</span>
					</a>
					<a class="animated fadeIn nav-link mb-1 d-flex align-items-center" data-toggle="pill" href="#tab_2" role="tab"
						...
						<span class="h4 mb-0 font-weight-bold">Business to Employee</span>
					</a>
				</div>
			</div>
